...
public:
    ...
    // print methods
    void printPrefix(TreeNode* tree);  // Prints data in prefix form
    void printInfix(TreeNode* tree);   // Prints data in infix form
    void printPostfix(TreeNode* tree); // Prints data in postfix form
	// made these 3 functions not const
	

    void printOutput();                // Prints in post, in, pre form
	// const also removed here
